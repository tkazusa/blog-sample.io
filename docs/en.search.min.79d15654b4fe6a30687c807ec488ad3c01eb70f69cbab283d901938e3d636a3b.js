...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0ea936a6bb9d4a6017362cf040eff34df99a30c0a8debae0845d12c73a78ef0e.js',function(){input.required=false;search();});}
