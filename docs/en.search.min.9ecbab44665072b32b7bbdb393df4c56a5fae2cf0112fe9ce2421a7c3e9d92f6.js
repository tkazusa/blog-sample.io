...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/blog-sample.io/flexsearch.min.js');loadScript('/blog-sample.io/en.search-data.min.0d3f285bbb02fb4f65a1c2d67b59139cb4034ae19a9ea534bd01780b0414ac50.js',function(){input.required=false;search();});}
